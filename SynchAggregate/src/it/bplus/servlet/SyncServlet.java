...
public class SyncServlet extends HttpServlet implements Servlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		logger.info("Inizio Sync Aggregate Servlet");//							      
		...
		try {
			String enable_automatic_sync=resource.getString("enable_automatic_sync_to_aggregate");			
			if(enable_automatic_sync!=null && enable_automatic_sync.equals("true")){
				...
				getServletContext().setAttribute("sync_to_aggregate", timer);
		...
		logger.info("Fine Sync Aggregate Servlet");
	}
